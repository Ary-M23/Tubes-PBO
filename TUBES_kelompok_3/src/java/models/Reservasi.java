...
public class Reservasi {
    ...
    public void saveToDatabase() throws SQLException {
        ...
        try (Connection connection = DatabaseConnection.getConnection(); // Mendapatkan koneksi dari kelas DatabaseConnection
            ...
            statement.executeUpdate(); // Menjalankan query untuk menyimpan data
        }
    }
}
